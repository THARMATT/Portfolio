    ...
    <div className="about " id="about">
      ...
      <div className="about-grid">
        <div className="about-grid-info">
          ...
          B.Tech graduate from Himachal Pradesh Technical University with a focus on holistic development. Led Computer Science department to sports victory, emphasizing teamwork and personal growth alongside academic excellence. </p>
          <p className="about-grid-info-text">
          Excelled in academics and extracurriculars, serving as Kabaddi captain, NCC cadet, and actively engaging in debate and personal growth, ultimately achieving 93% in 12th grade (Non-Medical) at Garhi Higher Secondary.
          </p>
          <p className="about-grid-info-text">
